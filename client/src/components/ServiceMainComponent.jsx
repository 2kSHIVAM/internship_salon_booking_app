    ...
    <a href className="c-card  block bg-black shadow-md hover:shadow-lg hover:shadow-yellow-500/50  rounded-lg overflow-hidden" onMouseEnter={handleHover} onMouseLeave={handleHover}>
      ...
      <div className="p-4">
        ...
        <div className="mt-3 flex items-center justify-center flex">
          ...
          <div className='ml-12'>
          <a href="#" class="lg:hover:animate-bounce inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-yellow-700 rounded-lg hover:bg-yellow-500 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            Book Now
